...
## Step 127 — Market Data Acceptance for Daily Review
- Added acceptance-layer mapping on top of freshness semantics for review consumption:
  - `acceptable_for_paper_review` (`fresh`/`delayed`)
