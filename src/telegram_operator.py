...
def _format_ai_team_packet_operator_fields(packet: dict[str, Any]) -> list[tuple[str, Any]]:
    ...
    return [
        ...
        ("slot_readiness_counts", f"ok={_safe_int_counter(slot.get('ok'))}, partial={_safe_int_counter(slot.get('partial'))}, missing={_safe_int_counter(slot.get('missing'))}, unknown={_safe_int_counter(slot.get('unknown'))}"),
        ("simulated_direction_counts", f"watch_only={_safe_int_counter(direction.get('watch_only'))}, mixed_watch={_safe_int_counter(direction.get('mixed_watch'))}, insufficient_data={_safe_int_counter(direction.get('insufficient_data'))}"),
