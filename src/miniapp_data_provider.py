...
class SupabaseLatestSystemRunMiniAppReadDataProvider(RailwayRuntimeEnvMiniAppReadDataProvider):
    ...
    def get_ai_team_packet_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "broker_connection": bool(packet.get("broker_connection", False)),
            "live_execution": bool(packet.get("live_execution", False)),
            "real_money_execution": bool(packet.get("real_money_execution", False)),
            "creates_orders": bool(packet.get("creates_orders", False)),
