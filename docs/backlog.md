...
- Step 34A message-format hotfix completed: fix Telegram HTML parse-mode placeholder issue by replacing angle-bracket placeholders in operator help/usage text with HTML-safe bracket placeholders.
